...
import { type TableCharacterProps } from '../constants/constants'

type useFocusTrapProps = { tableCharacters: TableCharacterProps[] }

export const useFocusTrap = ({ tableCharacters }: useFocusTrapProps) => {
    useEffect(() => {
